    ...
    return (
        <section className="py-16 border-y border-gray-100 bg-white">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="flex justify-center items-center gap-6 md:gap-10 lg:gap-16 overflow-x-auto py-4">
                    <div className="flex items-center justify-center transition-all h-10 md:h-12 w-auto">
