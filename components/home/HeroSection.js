    ...
    return (
        <section className="px-4 md:px-8 pb-10 md:pb-12 pt-8 md:pt-6 max-w-7xl mx-auto">
            <div className="relative w-full min-h-[640px] sm:min-h-[700px] md:h-[600px] rounded-3xl overflow-hidden shadow-2xl group">
                ...
                <div className="relative min-h-[640px] sm:min-h-[700px] md:h-[600px] flex flex-col justify-start sm:justify-center p-6 sm:p-8 md:p-16 text-white z-10">
                    <ScrollReveal className="max-w-2xl">
                        ...
                        <p className="invisible sm:visible text-[15px] sm:text-lg md:text-xl text-gray-300 max-w-md sm:max-w-lg mb-7 md:mb-10 leading-7 sm:leading-relaxed font-light">
                    ...
                    <div className="absolute inset-x-6 bottom-6 sm:hidden z-20 flex flex-col gap-4">
                        <Link
                            href="/products"
                        ...
                        <div className="group relative">
                            ...
                            <div className="relative max-w-[320px] backdrop-blur-xl bg-white/10 border border-white/20 p-3 pl-4 rounded-2xl flex flex-col items-stretch justify-between gap-3 shadow-2xl overflow-hidden transition-all duration-500 hover:translate-y-[-5px] hover:bg-white/10">
