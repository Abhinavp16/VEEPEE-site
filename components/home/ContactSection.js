            ...
            <div className="max-w-7xl mx-auto px-6 relative">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    <ScrollReveal>
                        ...
                        <h2 className="text-5xl font-primary font-bold text-white mb-8 leading-tight">
                        ...
                        <div className="space-y-10">
                            <div className="flex items-start gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-white leading-tight">7828832346 / 8962732346</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-6">
                                <div className="w-14 h-14 bg-brand-primary/10 rounded-2xl flex items-center justify-center text-brand-primary shrink-0">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-white italic underline decoration-brand-primary underline-offset-8 decoration-2">
                                        ixveepee@gmail.com
                                    </p>
                                </div>
                            </div>
