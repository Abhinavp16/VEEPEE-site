...
export default function SustainabilitySection() {
    return (
        <section className="py-16 px-5 sm:px-6 sm:py-24 max-w-7xl mx-auto overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-16 items-center">
                <ScrollReveal>
                    <div className="relative h-[300px] sm:h-[380px] lg:h-[500px] rounded-[2rem] sm:rounded-3xl overflow-hidden group">
                        <img
                        ...
                        <div className="absolute bottom-5 left-5 right-5 sm:bottom-8 sm:left-8 sm:right-8">
                            ...
                            <p className="text-white text-base sm:text-lg font-medium max-w-[18ch] sm:max-w-none">
                ...
                <ScrollReveal>
                    ...
                    <h2 className="text-[2.35rem] sm:text-4xl md:text-5xl font-primary font-bold text-text-primary mb-6 sm:mb-8 leading-[1.06] sm:leading-tight">
                        Sustainable Agriculture In Your Community
                    </h2>
                    <p className="text-text-secondary text-base sm:text-lg mb-6 sm:mb-8 leading-8 sm:leading-relaxed">
                    ...
                    <p className="text-text-secondary text-base sm:text-lg mb-8 sm:mb-10 leading-8 sm:leading-relaxed">
                    ...
                    <div className="flex flex-wrap gap-3 sm:gap-4">
                        <Link
                            href="/dealership"
                            className="px-6 py-3.5 sm:px-8 sm:py-4 bg-brand-primary text-white rounded-full font-bold text-sm sm:text-base hover:bg-brand-secondary transition-all shadow-[0_4px_14px_0_rgba(249,115,22,0.39)] flex items-center gap-3 group"
                        >
                            Join as a Dealer
                        ...
                        <Link
                            href="/#products"
                            className="px-6 py-3.5 sm:px-8 sm:py-4 bg-white border border-gray-200 text-text-primary rounded-full font-bold text-sm sm:text-base hover:border-brand-primary hover:text-brand-primary transition-all"
                        >
                            Buy Machines Now
                        </Link>
                    </div>
