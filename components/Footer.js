            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-12">
                    ...
                    <div className="flex flex-wrap justify-center gap-8 text-sm text-gray-400">
                        ...
                        <Link href="/dealership" className="hover:text-white transition-colors">Dealership</Link>
                    ...
                    <div className="flex gap-4">
                        <a
                            ...
                            className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-brand-primary transition-colors hover:text-white"
                        >
